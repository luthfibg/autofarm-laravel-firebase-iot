...
@section('content-title')
    <p style="font-size: 12pt">Realtime Data <span> <i>Refresh to show current data</i> </span><p>
@endsection
...
@section('content')
    ...
    <div class="overflow-hidden bg-white shadow sm:rounded-lg mt-3">
        <div class="px-4 py-5 sm:px-6">
          <h3 class="text-lg font-medium leading-6 text-gray-900">Perkembangan tanaman</h3>
          <p class="mt-1 max-w-2xl text-sm text-gray-500">Pantauan perkembangan tanaman terbaru</p>
        </div>
        <div class="border-t border-gray-200">
          <dl>
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt class="text-sm font-medium text-gray-500">Kelembapan tanah (humidity soil)</dt>
